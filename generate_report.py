...
DOCS_DIR = ROOT / "docs"
SUMMARY_CSV = EVAL_DIR / "eval_model_summary.csv"
...
def load_non_empty_counts():
    """Per-model count of non-empty answers from evaluation/eval_detailed_results.csv (best-effort)."""
    detailed = EVAL_DIR / "eval_detailed_results.csv"
    counts = {}
...
def build_docx(path: Path):
    ...
    Bullet("evaluation/evaluation_visualizations.py - matplotlib helpers for per-query, "
           "confusion-style, and Precision/Recall vs k plots")
    Bullet("evaluation/eval_detailed_results.csv, evaluation/eval_model_summary.csv, "
           "evaluation/eval_partial_<model>.csv - reproducible result artifacts")
    ...
    Img("evaluation/eval_model_quality_latency.png", width_inches=5.8,
    ...
    Img("evaluation/eval_llama_3_1_8b_instant_precision_recall_vs_k.png", width_inches=5.8,
    ...
    Img("evaluation/eval_llama_3_1_8b_instant_per_query_metrics.png", width_inches=6.2,
        caption="Figure 4. Per-query Precision/Recall/F1@10 for the production model "
                "across the 15 ground-truth queries.")
    Img("evaluation/eval_llama_3_1_8b_instant_confusion_matrix.png", width_inches=5.0,
    ...
    Code("# 1. Clone the repo and install dependencies\n"
         ...
         "   evaluation/eval_model_quality_latency.png \\\n"
         "   evaluation/eval_llama_3_1_8b_instant_per_query_metrics.png\n")
    ...
    Bullet("Each evaluation query's ground truth is generated by a deterministic "
           ...
           "error.")
    Bullet("evaluation/eval_partial_<model>.csv is written after every model finishes "
           "so a rate-limit-induced partial run can still be inspected and audited.")
...
def build_pdf(path: Path):
    ...
    P("Table 1. Per-model averages across 51 queries (15 with Cypher ground truth). "
      ...
      "constraints.", caption)
    Img("evaluation/eval_model_quality_latency.png", width_inches=5.4,
    ...
    Img("evaluation/eval_llama_3_1_8b_instant_precision_recall_vs_k.png", width_inches=5.4,
    ...
    Img("evaluation/eval_llama_3_1_8b_instant_per_query_metrics.png", width_inches=5.8,
        cap="Figure 4. Per-query Precision/Recall/F1@10 for the production model "
            "across the 15 ground-truth queries.")
    Img("evaluation/eval_llama_3_1_8b_instant_confusion_matrix.png", width_inches=4.6,
    ...
    B("evaluation/eval_partial_&lt;model&gt;.csv is written after every model finishes "
      "so a rate-limit-induced partial run can still be inspected.")
...
if __name__ == "__main__":
    ...
    docx_path = REPORT_DIR / "Report_Final.docx"
    pdf_path = REPORT_DIR / "Report_Final.pdf"
